...
- Smoother talkgroup card animations when activity stops
- Clearer tune and talkgroup labels in the UI
- Improved theme controls (desktop menu, mobile quick cycle)
- Up to 25 live cards shown at once; selected talkgroup always stays visible
- General stability and polish for beta testers

## 0.4.0-beta.2

- Live talkgroup grid with enter/exit animations
- Dismissible volume dock on desktop
- Light / dark / auto theme
- Faster, cleaner monitor UI on mobile

## 0.3.0-beta.1

- In-browser listening for a selected talkgroup
- Speech clarity option in the listening desk
- Live activity cards and recent history
